...
namespace ParkourScugPlugin.Creatures;
    ...
    sealed class CamoCentipedeCritob : Critob
    {
        internal CamoCentipedeCritob() : base(CreatureTemplateType.CamoCentipede)
        {
            base.Icon = new SimpleIcon("Kill_Centipede2", new Color(1f, 1f, 1f));
            
            base.SandboxPerformanceCost = new SandboxPerformanceCost(1f, 0.7f);
            base.RegisterUnlock(KillScore.Configurable(10), SandboxUnlockID.CamoCentipede, null, 0);
        ...
        {
        CreatureTemplate creatureTemplate = new CreatureFormula(CreatureTemplate.Type.Centipede, base.Type, "CamoCentipede")
        {
